...
static bool bt_spi_irq_pin_high(void)
{
	u32_t pin_state;
...
static void bt_spi_init_irq_high_loop(void)
{
	attempts = IRQ_HIGH_MAX_READ;
}

static bool bt_spi_exit_irq_high_loop(void)
{
...
#define bt_spi_irq_pin_high(...) 0
#define bt_spi_init_irq_high_loop(...)
#define bt_spi_exit_irq_high_loop(...) 1
#endif
